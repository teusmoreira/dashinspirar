...
# --- BARRA LATERAL (SEM FILTRO DE DATA) ---
with st.sidebar:
...
if df is not None:
    ...
    # Aba 3: Temporal (Sem filtro de período, mas com correção de hora)
    with tab3:
                ...
                if isinstance(row[col], list):
                    for log in row[col]:
                        ...
                        if pd.notnull(d):
                            ...
                            # Adiciona direto (sem filtro de data)
        ...
        if not df_l.empty:
            ...
            with c_F:
                ...
                # Remove registros de 00:00 (datas sem hora)
